...
class Zomato:
    ...
    def get_city_ID(self, city_name):
        ...
        elif 'name' in r['location_suggestions'][0]:
    ...
    def is_city_available(self,city_name):
        """
        Checks if the city entered is in the available list of cities.
        Returns a boolean value.
        """
        tier_1 = ["Ahmedabad", "Bangalore", "Chennai", "Delhi", "Hyderabad", "Kolkata" , "Mumbai", "Nilambur", "Pune"]
        tier_2 = ["Agra","Ajmer","Aligarh","Amravati","Amritsar","Asansol","Aurangabad","Bareilly","Belgaum","Bhavnagar","Bhiwandi","Bhopal","Bhubaneswar","Bikaner","Bilaspur","Bokaro Steel City","Chandigarh","Coimbatore","Cuttack","Dehradun","Dhanbad","Bhilai","Durgapur","Erode","Faridabad","Firozabad","Ghaziabad","Gorakhpur","Gulbarga","Guntur","Gwalior","Gurgaon","Guwahati","Hamirpur","Hubli–Dharwad","Indore","Jabalpur","Jaipur","Jalandhar","Jammu","Jamnagar","Jamshedpur","Jhansi","Jodhpur","Kakinada","Kannur","Kanpur","Kochi","Kolhapur","Kollam","Kozhikode","Kurnool","Ludhiana","Lucknow","Madurai","Malappuram","Mathura","Goa","Mangalore","Meerut","Moradabad","Mysore","Nagpur","Nanded","Nashik","Nellore","Noida","Patna","Pondicherry","Purulia","Prayagraj","Raipur","Rajkot","Rajahmundry","Ranchi","Rourkela","Salem","Sangli","Shimla","Siliguri","Solapur","Srinagar","Surat","Thiruvananthapuram","Thrissur","Tiruchirappalli","Tiruppur","Ujjain","Bijapur","Vadodara","Varanasi","Vasai-Virar City","Vijayawada","Visakhapatnam","Vellore", "Warangal"]
        if ((city_name == None) or (city_name == "")):
            if ((city_name.capitalize()  in tier_1) or (city_name.capitalize()  in tier_2)):
                return True
            else:
                return False
        else:
    ...
    def send_email(self,sender,reciever,sender_password,response,smtp_server,smtp_port):
        try:
            ...
            return False
            raise ("Error in processing the Email :: ",e)
